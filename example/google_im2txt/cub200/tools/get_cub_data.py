# -*- coding: utf-8 -*-
# @File    : google_im2txt/get_cub_data.py
# @Info    : @ TSMC-SIGGRAPH, 2018/7/8
# @Desc    :
# -.-.. - ... -- -.-. .-.. .- -... .---.   -.-- ..- .-.. --- -. --.   ..-. .- -. 
...
class DataBase(object):
    ...
    def _parse_sequence_example(self, example):
        ...
        image_filename = tf.cast(context_parsed['image/filename'], tf.string)
        ...
        image_caption_id_pair = [image_filename, image_resized, caption_ids_decoded]
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for i in range(100):
            ...
            if i > 50 and i % 5 == 0:
                image_filename, image, caption_ids = image_caption_pair
                scipy.misc.imsave("/result/%02d_%s" % (i, image_filename[0]), image[0])
