# -*- coding: utf-8 -*-
# @File    : google_im2txt/build_data.py
...
tf.flags.DEFINE_string("train_image_dir", "/dataset/flickr8k/train",
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", "/dataset/flickr8k/val",
                       "Training image directory.")
tf.flags.DEFINE_string("test_image_dir", "/dataset/flickr8k/test",
                       "Training image directory.")

tf.flags.DEFINE_string("train_captions_file", "/dataset/flickr8k/flickr8k_train_captions",
                       "Training captions text file.")
tf.flags.DEFINE_string("val_captions_file", "/dataset/flickr8k/flickr8k_val_captions",
                       "Training captions text file.")
tf.flags.DEFINE_string("test_captions_file", "/dataset/flickr8k/flickr8k_test_captions",
                       "Training captions text file.")

tf.flags.DEFINE_string("output_dir", "/dataset/flickr8k_tfrecord", "Output data directory.")
...
tf.flags.DEFINE_string("word_counts_output_file", "/dataset/flickr8k_tfrecord/word_counts.txt",
...
def _load_and_process_metadata(captions_file, image_dir):
    ...
    for line in captions_data:
        _img_filename, _annotation = line.strip().split(".jpg#")  # owing to individual descriptions containing sharp symbol
        _img_filename = _img_filename + ".jpg"
...
def main(_):
    ...
    train_dataset = _load_and_process_metadata(FLAGS.train_captions_file, FLAGS.train_image_dir)
    val_dataset = _load_and_process_metadata(FLAGS.val_captions_file, FLAGS.val_image_dir)
    test_dataset = _load_and_process_metadata(FLAGS.test_captions_file, FLAGS.test_image_dir)
