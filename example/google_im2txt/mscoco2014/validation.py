# -*- coding: utf-8 -*-
# @File    : contentDelivery/validation.py
# @Info    : @ TSMC-SIGGRAPH, 2018/7/5
# @Desc    :
# -.-.. - ... -- -.-. .-.. .- -... .---.   -.-- ..- .-.. --- -. --.   ..-. .- -. 
...
def main(_):
    ...
    # note: assert FLAGS.input_files == 'utils/test_new_fullfilenames'
    ...
    with tf.Session(graph=g) as sess:
        ...
        store_json_file("google_im2txt_cap.json", json_file)
