...
tf.flags.DEFINE_string("train_image_dir", "/dataset/flickr30k/flickr30k_images",
                       "Training image directory.")

tf.flags.DEFINE_string("train_captions_file", "/dataset/flickr30k/flickr30k_captions",
                       "Training captions text file.")

tf.flags.DEFINE_string("output_dir", "/dataset/flickr30k_tfrecord", "Output data directory.")
...
tf.flags.DEFINE_string("word_counts_output_file", "/dataset/flickr30k_tfrecord/word_counts.txt",
...
def main(_):
    ...
    flickr_dataset = _load_and_process_metadata(FLAGS.train_captions_file,
                                                FLAGS.train_image_dir)

    # Redistribute the oxford-102flower dataset as follows:
    #   train_dataset: 31783 - 2000 = 29783 for training
    #   val_dataset: 1000 for validation during training.
    #   test_dataset:   1000 for final evaluation.
    train_cutoff = -2000
    val_cutoff = -1000
