...
# note: 留神一下length_normalization_factor在x!=0时的评分公式logprob/length^x,在x=0时,用的log(prob)
# This changes the relative scores of captions depending on their lengths,更长的caption在获得高分时会更有利
class CaptionGenerator(object):
    ...
    def beam_search(self, sess, encoded_image):
        ...
        partial_captions.push(initial_beam)  # review: 目前为止,起始堆中就只有起始符号和图像特征构成的初始beam
